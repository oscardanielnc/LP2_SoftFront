...
{
    public partial class tarjCursoAsesorado : Form
    {
        private int _idCurso;
        private CursosWS.CursosWSClient _daoCurso;
        private CursosWS.curso _cursoVer;
        public tarjCursoAsesorado(CursosWS.curso curso)
        {
        ...
        private void posicionarLabel(CursosWS.curso curso)
        {
            ...
            lblNivel.Text = "Nivel " + curso.nivel + " ";
        }

        private void tarjCursoAsesorado_Click(object sender, EventArgs e)
        {
